...
const RecipeInfo = ({ recipe, chef }) => {
    const [isFavourite,setFavourite]=useState(false)

    const handleFavouritre = ()=>{
        setFavourite(true)
      ...
      <div className="lg:p-10 bg-sky-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 lg:m-4">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-center m-5">
            <span className="text-3xl font-bold text-orange-500 dark:text-white"></span>
           {
            isFavourite ?  <button disabled className="text-white btn btn-sm ">
            Favourite
          </button> :   <button onClick={()=>handleFavouritre()} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Favourite
            </button>
           }
          </div>
